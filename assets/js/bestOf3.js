...
let gameNumber = 1; // Tracks the round number (1-3)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function checkWin(player1, player2) {
    ...
    let outcomeText = `Game ${gameNumber}/3`; // Update the round number (Best of 3)
    ...
    switch (outcome) {
      case 1:
        ...
        if (currentWins >= 3) { // Player wins Best of 3
          outcomeText = 'You won the Best of 3!';
      ...
      case -1:
        ...
        if (currentLosses >= 3) { // CPU wins Best of 3
          outcomeText = 'Computer won the Best of 3!';
  ...
  function resetGame() {
    // Reset the win counters and game number for a new Best of 3 game
    currentWins = 0;
    currentLosses = 0;
    gameNumber = 1;
